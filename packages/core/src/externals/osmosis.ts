...
export class MsgSetRewardReceiverAddressResponse extends Message<MsgSetRewardReceiverAddressResponse> {
  ...
  static equals(
    a: MsgSetRewardReceiverAddressResponse | PlainMessage<MsgSetRewardReceiverAddressResponse> | undefined,
    b: MsgSetRewardReceiverAddressResponse | PlainMessage<MsgSetRewardReceiverAddressResponse> | undefined,
  ): boolean {
